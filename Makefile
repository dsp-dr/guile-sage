...
SAGE_PKGS_CLOJURE ?= clojure leiningen rlwrap clojure-mode.el clojure-cider
SAGE_PKGS_COHORT  ?= ecl lua54 fennel chez-scheme node ruby ghc scala kotlin elixir ocaml perl5 rust sbcl nim crystal deno janet
